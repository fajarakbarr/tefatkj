    ...
    <div class="col-sm d-flex align-items-stretch">
        <div class="card w-100 border border-2">
            <div class="card-body p-4">
                ...
                <form action="/tahunAjaran/update/<?= $tahun_ajaran['id_tahun_ajaran'] ?>" method="post" id="formEdit">
                    <?= csrf_field() ?>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control <?= isset(session()->get('errors')['tahun_ajaran']) ? 'is-invalid' : '' ?>" name="tahun_ajaran" id="tahun_ajaran" placeholder="Tahun Ajaran" value="<?= $tahun_ajaran['tahun_ajaran'] ?>" autocomplete="off">
